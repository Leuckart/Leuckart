...
test_ast "(() -> int)f(){(decl [5]char s {'a','s','d','f','\0'});}" 'char s[5]="asdf";'
test_ast "(() -> int)f(){(decl [5]char s {'a','s','d','f','\0'});}" 'char s[]="asdf";'
...
test_astf '((int) -> int)f(int c){c;}' 'int f(int c){c;}'
test_astf '((int) -> int)f(int c){c;}((int) -> int)g(int d){d;}' 'int f(int c){c;} int g(int d){d;}'
