/**************************************************
	> File Name:  Sword_28_SymmetricalBinaryTree.cpp
	> Author:     Leuckart
	> Time:       2020-02-18 03:32
**************************************************/
...
bool isSymmetricalRecursive(BinaryTreeNode *pRoot1, BinaryTreeNode *pRoot2)
{
	if (!pRoot1 && !pRoot2)
		return true;

	if (pRoot1 && pRoot2 && pRoot1->m_nValue == pRoot2->m_nValue)
		return isSymmetricalRecursive(pRoot1->m_pLeft, pRoot2->m_pRight) &&
			   isSymmetricalRecursive(pRoot1->m_pRight, pRoot2->m_pLeft);
	return false;
}
...
bool isSymmetrical(BinaryTreeNode *pRoot)
{
	if (!pRoot)
		return true;
	return isSymmetricalRecursive(pRoot->m_pLeft, pRoot->m_pRight);
}
