/**************************************************
	> File Name:  Sword_52_FirstCommonNodesInLists.cpp
	> Author:     Leuckart
	> Time:       2020-02-26 20:59
**************************************************/
...
{
	int len1 = 0;
	for (ListNode *pIter = pHead1; pIter != nullptr; ++len1)
		pIter = pIter->m_pNext;

	int len2 = 0;
	for (ListNode *pIter = pHead2; pIter != nullptr; ++len2)
		pIter = pIter->m_pNext;
