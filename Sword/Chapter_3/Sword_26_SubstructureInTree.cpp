/**************************************************
	> File Name:  Sword_26_SubstructureInTree.cpp
	> Author:     Leuckart
	> Time:       2020-02-18 02:53
**************************************************/
...
bool HasSubtree(BinaryTreeNode *pRoot1, BinaryTreeNode *pRoot2)
{
	...
	{
		return (HasSubtree(pRoot1->m_pLeft, pRoot2->m_pLeft) &&
				HasSubtree(pRoot1->m_pRight, pRoot2->m_pRight)) ||
			   HasSubtree(pRoot1->m_pLeft, pRoot2) ||
			   HasSubtree(pRoot1->m_pRight, pRoot2);
	}
	else
	{
		return HasSubtree(pRoot1->m_pLeft, pRoot2) ||
			   HasSubtree(pRoot1->m_pRight, pRoot2);
	}
	return false;
}
