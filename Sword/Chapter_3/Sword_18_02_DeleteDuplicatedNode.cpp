/**************************************************
	> File Name:  Sword_18_02_DeleteDuplicatedNode.cpp
	> Author:     Leuckart
	> Time:       2020-02-17 15:01
**************************************************/
...
void DeleteDuplication(ListNode **pHead)
{
	...
	while (pCur)
	{
		...
		bool toDel = false;
		if (pNext && pNext->m_nValue == pCur->m_nValue)
			toDel = true;
		...
		{
			int val = pCur->m_nValue;
			do
			{
				delete pCur;
				pCur = pNext;
				pNext = pNext->m_pNext;
			} while (pNext && pNext->m_nValue == val);
